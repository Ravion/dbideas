...
<div style="padding:5px">
	<h2 >dbIdeas <span style="font-weight:bold;color:black">[v. ${dbIdeas_version}]</span> </h2><br/>
...
<tr><td>Total Memory</td><td>${totalMemory}</td></tr>
	...
	<p>dbIdeas is running on: <%=serverInfo %><br/></p>
	<p style="color:red"><br/><b>dbIdeas is built on top of the following software:</b><br/></p>
